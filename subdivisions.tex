%\chapter{Multiple Bibliographies}
\chapter{多重文献表}\label{ch:subdivisions}
...
%\paragraph{How \biblatex\ chooses.}
\paragraph{biblatex 怎么进行筛选} All these distinctions are brought
