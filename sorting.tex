...
but there are occasions when you may need to intervene.\marginpar{\footnotesize 可以在 bib 文件内，设置 sortname，sorttitle，sortyear 以实现根据给出的域信息进行排序。可以指定 presort 域提供更早的排序信息。也可以指定 sortkey 来明确可以参与排序的域。
}
